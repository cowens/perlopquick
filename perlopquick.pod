...
L<< /X -> Y >>, L<perlreftut>, and L<perlref>
...
This is the readable filetest operator.  X must be a filename, filehandle,
dirhandle, or an expression that returns one the preceding values.  It
returns C<1> if the file or directory exists and is readable, C<""> if it
exists but if it not readable, or C<undef> if the file does not exist.
...
This is the writable filetest operator.  X must be a filename, filehandle,
dirhandle, or an expression that returns one the preceding values.  It
returns C<1> if the file or directory exists and is writable, C<""> if it
exists but if it not writable, or C<undef> if the file does not exist.
...
This is the executable filetest operator.  X must be a filename, filehandle,
dirhandle, or an expression that returns one the preceding values.  It
returns C<1> if the file or directory exists and is executable, C<""> if it
exists but if it not executable, or C<undef> if the file does not exist.
...
=head3 Example
    ...
    if (-x $^X) {
        print "the Perl interpreter is executable\n";
    } else {
        print "the Perl interpreter is not executable\n";
    }
